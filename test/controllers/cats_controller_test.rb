...
class CatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cat" do
    assert_difference('Cat.count') do
      post cats_url, params: { cat: { birth_date: @cat.birth_date, color: @cat.color, description: @cat.description, name: @cat.name, sex: @cat.sex } }
    end
  ...
  test "should update cat" do
    patch cat_url(@cat), params: { cat: { birth_date: @cat.birth_date, color: @cat.color, description: @cat.description, name: @cat.name, sex: @cat.sex } }
